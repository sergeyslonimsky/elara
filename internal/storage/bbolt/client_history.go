...
func NewClientHistoryRepo(manager *Manager) *ClientHistoryRepo {
	return &ClientHistoryRepo{manager: manager}
}
...
func (r *ClientHistoryRepo) Save(ctx context.Context, c *domain.Client) error {
...
// limit <= 0 returns all.
func (r *ClientHistoryRepo) List(ctx context.Context, limit int) ([]*domain.Client, error) {
...
func (r *ClientHistoryRepo) Count(ctx context.Context) (int, error) {
	var n int
...
func (r *ClientHistoryRepo) DeleteOldest(ctx context.Context, n int) (int, error) {
	if n <= 0 {
		return 0, nil
	}
...
func (r *ClientHistoryRepo) DeleteOlderThan(ctx context.Context, cutoff time.Time) (int, error) {
