...
func NewSchemaRepo(manager *Manager) *SchemaRepo {
	return &SchemaRepo{manager: manager}
}

func (r *SchemaRepo) Attach(ctx context.Context, s *domain.SchemaAttachment) error {
...
func (r *SchemaRepo) Detach(ctx context.Context, namespace, pathPattern string) error {
	err := r.manager.Update(ctx, func(tx *bolt.Tx) error {
		b := tx.Bucket([]byte(bucketSchemas))
...
func (r *SchemaRepo) List(ctx context.Context, namespace string) ([]*domain.SchemaAttachment, error) {
