...
func setupHandler(t *testing.T) (*Handler, *config_mock.MockconfigUsecase) {
	t.Helper()
	ctrl := gomock.NewController(t)
	uc := config_mock.NewMockconfigUsecase(ctrl)
	h := New(uc)
...
func TestConfigHandler_GetConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Get(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_GetConfig_Forbidden(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Get(gomock.Any(), gomock.Any()).Return(nil, domain.ErrForbidden)
...
func TestConfigHandler_CreateConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Create(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_UpdateConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Update(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_ListConfigs_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().List(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_GetConfigHistory_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().History(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_CopyConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Copy(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_ValidateConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Validate(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_GetConfigDiff_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Diff(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
...
func TestConfigHandler_LockConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Lock(gomock.Any(), gomock.Any()).Return(domain.ErrUnauthorized)
...
func TestConfigHandler_UnlockConfig_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().Unlock(gomock.Any(), gomock.Any()).Return(domain.ErrUnauthorized)
...
func TestConfigHandler_GetConfigAtRevision_Unauthorized(t *testing.T) {
	...
	h, uc := setupHandler(t)
	uc.EXPECT().GetAtRevision(gomock.Any(), gomock.Any()).Return(nil, domain.ErrUnauthorized)
