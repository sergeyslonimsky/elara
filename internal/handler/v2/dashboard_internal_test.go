...
func TestDashboardHandler_GetStats_Success(t *testing.T) {
	...
	h := &DashboardHandler{uc: dashboarduc.NewUseCase(enforcer, ns, configs, nil, clients)}
...
func TestDashboardHandler_GetStats_Unauthorized(t *testing.T) {
	...
	h := &DashboardHandler{uc: dashboarduc.NewUseCase(nil, nil, nil, nil, nil)}
...
func TestDashboardHandler_GetStats_Forbidden(t *testing.T) {
	...
	h := &DashboardHandler{uc: dashboarduc.NewUseCase(enforcer, nil, nil, nil, nil)}
