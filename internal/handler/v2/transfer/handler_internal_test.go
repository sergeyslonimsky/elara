...
func TestTransferHandler_ExportNamespace_Success(t *testing.T) {
	...
	h := &Handler{exportNamespace: transferuc.NewExportNamespaceUseCase(enforcer, configs, namespaces)}
	ctx := testCtx()
...
func TestTransferHandler_ExportNamespace_Unauthorized(t *testing.T) {
	...
	h := &Handler{exportNamespace: transferuc.NewExportNamespaceUseCase(nil, nil, nil)}
...
func TestTransferHandler_ExportNamespace_NamespaceNotFound(t *testing.T) {
	...
	h := &Handler{exportNamespace: transferuc.NewExportNamespaceUseCase(enforcer, nil, namespaces)}
	ctx := testCtx()
