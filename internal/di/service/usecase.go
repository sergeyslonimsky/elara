...
func NewUseCases(a *Adapters) *UseCases {
	return &UseCases{
		...
		LockConfig:     configuc.NewLockUseCase(a.ConfigRepo),
		UnlockConfig:   configuc.NewUnlockUseCase(a.ConfigRepo),
		...
		LockNamespace:   nsuc.NewLockUseCase(a.NamespaceRepo),
		UnlockNamespace: nsuc.NewUnlockUseCase(a.NamespaceRepo),
