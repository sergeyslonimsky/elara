...
// Returns a new session token with PasswordChangeRequired cleared.
func (uc *ChangePasswordUseCase) Execute(ctx context.Context, currentPassword, newPassword string) (string, error) {
