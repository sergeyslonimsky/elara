...
// Source: github.com/sergeyslonimsky/elara/internal/usecase/dashboard (interfaces: dashboardEnforcer,nsLister,configCounter,activitySource,activeClientsSource)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_usecase.go -package=mock_dashboard . dashboardEnforcer,nsLister,configCounter,activitySource,activeClientsSource
//
...
// MockdashboardEnforcer is a mock of dashboardEnforcer interface.
type MockdashboardEnforcer struct {
	ctrl     *gomock.Controller
	recorder *MockdashboardEnforcerMockRecorder
	isgomock struct{}
}

// MockdashboardEnforcerMockRecorder is the mock recorder for MockdashboardEnforcer.
type MockdashboardEnforcerMockRecorder struct {
	mock *MockdashboardEnforcer
}

// NewMockdashboardEnforcer creates a new mock instance.
func NewMockdashboardEnforcer(ctrl *gomock.Controller) *MockdashboardEnforcer {
	mock := &MockdashboardEnforcer{ctrl: ctrl}
	mock.recorder = &MockdashboardEnforcerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockdashboardEnforcer) EXPECT() *MockdashboardEnforcerMockRecorder {
	return m.recorder
}

// Enforce mocks base method.
func (m *MockdashboardEnforcer) Enforce(subject, arg1, object, action string) (bool, error) {
	m.ctrl.T.Helper()
...
func (mr *MockdashboardEnforcerMockRecorder) Enforce(subject, arg1, object, action any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Enforce", reflect.TypeOf((*MockdashboardEnforcer)(nil).Enforce), subject, arg1, object, action)
}
