...
const (
	...
	TokenServiceName = "elara.auth.v1.TokenService"
)
...
const (
	...
	// RPC.
	TokenServiceCreateTokenProcedure = "/elara.auth.v1.TokenService/CreateToken"
	// TokenServiceListTokensProcedure is the fully-qualified name of the TokenService's ListTokens RPC.
	TokenServiceListTokensProcedure = "/elara.auth.v1.TokenService/ListTokens"
	// TokenServiceGetTokenProcedure is the fully-qualified name of the TokenService's GetToken RPC.
	TokenServiceGetTokenProcedure = "/elara.auth.v1.TokenService/GetToken"
	// TokenServiceRevokeTokenProcedure is the fully-qualified name of the TokenService's RevokeToken
	// RPC.
	TokenServiceRevokeTokenProcedure = "/elara.auth.v1.TokenService/RevokeToken"
)

// TokenServiceClient is a client for the elara.auth.v1.TokenService service.
...
// NewTokenServiceClient constructs a client for the elara.auth.v1.TokenService service. By default,
...
func NewTokenServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TokenServiceClient {
	...
	tokenServiceMethods := v1.File_elara_auth_v1_token_service_proto.Services().ByName("TokenService").Methods()
...
// CreateToken calls elara.auth.v1.TokenService.CreateToken.
...
// ListTokens calls elara.auth.v1.TokenService.ListTokens.
...
// GetToken calls elara.auth.v1.TokenService.GetToken.
...
// RevokeToken calls elara.auth.v1.TokenService.RevokeToken.
...
// TokenServiceHandler is an implementation of the elara.auth.v1.TokenService service.
...
func NewTokenServiceHandler(svc TokenServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/elara.auth.v1.TokenService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedTokenServiceHandler) CreateToken(context.Context, *connect.Request[v1.CreateTokenRequest]) (*connect.Response[v1.CreateTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.auth.v1.TokenService.CreateToken is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) ListTokens(context.Context, *connect.Request[v1.ListTokensRequest]) (*connect.Response[v1.ListTokensResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.auth.v1.TokenService.ListTokens is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) GetToken(context.Context, *connect.Request[v1.GetTokenRequest]) (*connect.Response[v1.GetTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.auth.v1.TokenService.GetToken is not implemented"))
}
...
func (UnimplementedTokenServiceHandler) RevokeToken(context.Context, *connect.Request[v1.RevokeTokenRequest]) (*connect.Response[v1.RevokeTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.auth.v1.TokenService.RevokeToken is not implemented"))
}
