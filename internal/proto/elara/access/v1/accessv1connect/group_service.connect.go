...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/sergeyslonimsky/elara/internal/proto/elara/access/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GroupServiceName = "elara.access.v1.GroupService"
)
...
const (
	...
	// RPC.
	GroupServiceCreateGroupProcedure = "/elara.access.v1.GroupService/CreateGroup"
	// GroupServiceGetGroupProcedure is the fully-qualified name of the GroupService's GetGroup RPC.
	GroupServiceGetGroupProcedure = "/elara.access.v1.GroupService/GetGroup"
	// GroupServiceUpdateGroupProcedure is the fully-qualified name of the GroupService's UpdateGroup
	// RPC.
	GroupServiceUpdateGroupProcedure = "/elara.access.v1.GroupService/UpdateGroup"
	// GroupServiceDeleteGroupProcedure is the fully-qualified name of the GroupService's DeleteGroup
	// RPC.
	GroupServiceDeleteGroupProcedure = "/elara.access.v1.GroupService/DeleteGroup"
	// GroupServiceListGroupsProcedure is the fully-qualified name of the GroupService's ListGroups RPC.
	GroupServiceListGroupsProcedure = "/elara.access.v1.GroupService/ListGroups"
	// GroupServiceAddMemberProcedure is the fully-qualified name of the GroupService's AddMember RPC.
	GroupServiceAddMemberProcedure = "/elara.access.v1.GroupService/AddMember"
	// GroupServiceRemoveMemberProcedure is the fully-qualified name of the GroupService's RemoveMember
	// RPC.
	GroupServiceRemoveMemberProcedure = "/elara.access.v1.GroupService/RemoveMember"
)

// GroupServiceClient is a client for the elara.access.v1.GroupService service.
...
// NewGroupServiceClient constructs a client for the elara.access.v1.GroupService service. By
...
func NewGroupServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GroupServiceClient {
	...
	groupServiceMethods := v1.File_elara_access_v1_group_service_proto.Services().ByName("GroupService").Methods()
...
// CreateGroup calls elara.access.v1.GroupService.CreateGroup.
...
// GetGroup calls elara.access.v1.GroupService.GetGroup.
...
// UpdateGroup calls elara.access.v1.GroupService.UpdateGroup.
...
// DeleteGroup calls elara.access.v1.GroupService.DeleteGroup.
...
// ListGroups calls elara.access.v1.GroupService.ListGroups.
...
// AddMember calls elara.access.v1.GroupService.AddMember.
...
// RemoveMember calls elara.access.v1.GroupService.RemoveMember.
...
// GroupServiceHandler is an implementation of the elara.access.v1.GroupService service.
...
func NewGroupServiceHandler(svc GroupServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/elara.access.v1.GroupService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedGroupServiceHandler) CreateGroup(context.Context, *connect.Request[v1.CreateGroupRequest]) (*connect.Response[v1.CreateGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.CreateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) GetGroup(context.Context, *connect.Request[v1.GetGroupRequest]) (*connect.Response[v1.GetGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.GetGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) UpdateGroup(context.Context, *connect.Request[v1.UpdateGroupRequest]) (*connect.Response[v1.UpdateGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.UpdateGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) DeleteGroup(context.Context, *connect.Request[v1.DeleteGroupRequest]) (*connect.Response[v1.DeleteGroupResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.DeleteGroup is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) ListGroups(context.Context, *connect.Request[v1.ListGroupsRequest]) (*connect.Response[v1.ListGroupsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.ListGroups is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) AddMember(context.Context, *connect.Request[v1.AddMemberRequest]) (*connect.Response[v1.AddMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.AddMember is not implemented"))
}
...
func (UnimplementedGroupServiceHandler) RemoveMember(context.Context, *connect.Request[v1.RemoveMemberRequest]) (*connect.Response[v1.RemoveMemberResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("elara.access.v1.GroupService.RemoveMember is not implemented"))
}
